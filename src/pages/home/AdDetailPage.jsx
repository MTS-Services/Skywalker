      ...
      <div className="overflow-x-hidden" dir={isRTL ? "rtl" : "ltr"}>
        <div className="flex flex-col items-center bg-primary-700 text-primary-50 rounded-b-lg px-4 sm:px-6 py-8">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            ...
            <button onClick={() => handleShareClick(ad)} className='flex items-center justify-center gap-1.5 rounded-full bg-primary-600 py-1.5 px-3 text-sm hover:bg-primary-500 transition-colors'>
              <FiShare2 />
            </button>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-4 sm:p-6 text-center text-dark text-base md:text-lg leading-relaxed">
            {ad.description}
          </div>
        </div>

        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center px-4">
          <a href={`tel:${ad.whatsapp}`} className="w-full sm:w-auto text-base shrink-0 inline-flex items-center justify-center gap-2 select-none whitespace-nowrap transition-colors disabled:opacity-50 h-12 rounded-lg font-bold bg-success text-on-success active:bg-active-success px-6 bg-primary-300 text-white">
